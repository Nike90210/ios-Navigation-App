...
class ProfileHeaderView: UITableViewHeaderFooterView {
    ...
    func subViews (){
        ...
        fulNamelabel.backgroundColor = .white
        ...
        self.contentView.addSubview(fulNamelabel)
        self.contentView.addSubview(statusLabel)
        self.contentView.addSubview(button)
        self.contentView.addSubview(statusTexField)
        self.contentView.addSubview(imageView)
        self.contentView.backgroundColor = .white

        NSLayoutConstraint.activate([
            fulNamelabel.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 50),
            ...
            button.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -20),
